...
function undermenu($dbh, $ulogin, $page, $m)
  ...
  if($page == "anmal" or $page == "object" or $page == 'edit' or $page == 'editdubbel' or $page == 'tshirt' or $page == 'kvalval' or $page == 'funktionar') // "object" and "edit" needs extra identifiers - PAL: going for a unified "object" and "edit" for now...
    {
