...
define('UL_PDO_CON_STRING', 'mysql:host=127.0.0.1;dbname=epcUser');
// Example for SQLite: 
...
// logins table.
define('UL_PDO_AUTH_USER', 'epcAuth');
define('UL_PDO_AUTH_PWD', '898QXNe9fXbtGNA4');

// LOGIN UPDATE
// Used to add new and modify login data.
// Database user with SELECT, UPDATE and INSERT access to the
// logins table.
define('UL_PDO_UPDATE_USER', 'epcUdate');
define('UL_PDO_UPDATE_PWD', 'YQzuV7PLTXe7a2C3');

// LOGIN DELETE
// Used to remove logins.
// Database user with SELECT and DELETE access to the
// logins table
define('UL_PDO_DELETE_USER', 'epcDelete');
define('UL_PDO_DELETE_PWD', 'Re4Tpw6zVyeHNNz4');

// SESSION
// Database user with SELECT, UPDATE and DELETE permissions to the
// sessions and nonces tables.
define('UL_PDO_SESSIONS_USER', 'epcSessions');
define('UL_PDO_SESSIONS_PWD', 'DK7Q8QG5n9L8s4Nw');

// LOG
// Used to log events and analyze previous activity.
// Database user with SELECT, INSERT and DELETE access to the
// logins-log table.
define('UL_PDO_LOG_USER', 'epcLog');
define('UL_PDO_LOG_PWD', 'ZKh3jsTqSLxa3WjD');
