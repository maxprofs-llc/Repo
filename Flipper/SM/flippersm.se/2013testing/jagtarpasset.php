...
// input data
    $sql = "UPDATE sm_2013_funkis SET Person_no = $no WHERE Funk_id = $pass";
    $sqlResult = MySQL_query($sql,$db);
    $intRows = MySQL_affected_rows();


		$sql = "SELECT Tag, Firstname, Lastname FROM sm_2013_anmalda WHERE No = $no";
 ...
 //   $booAdminMail = mail("per.martinson@gmail.com", "Funkisanmälan - $tag: $pass", "Nu har ett funkispass fått sin funktionär.", "From: SM 2013 <webb@flippersm.se>");

    $booPlayerMail = mail($mail, "Funktionär på flipper-SM 2013", "Tack!\n\nDu har nu anmält dig som funktionär till Flipper-SM, 16-18 november 2013!\n\nDitt pass är nummer $pass, som du kan se på funkisschema-sidan på www.flippersm.se", "From: Flipper-SM 2013 <hans@hulabeck.se>");
    ...
    if($intRows == 1  && $booPlayerMail)
        ...
        echo "<div class=\"bred\">";
        echo "<h2>Tack för din insats på Flipper-SM 2013</h2>\n\n";
