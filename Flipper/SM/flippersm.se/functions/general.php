  ...
  function getQualGroupForm($dbh, $player, $tournament = 1) {
    ...
    $content = '
          <div id="qualGroupDiv">
            ...
            <p class="italic"><input type="radio" '.$prefered.' class="qualGroupRadio">Använd radioknapparna för att göra dina förstahandsval - en per division.<br/>
            <input type="checkbox" '.$checked.' class="qualGroupCheckbox">Använd checkboxarna för att välja övriga kvaltider som passar dig.</p>
            <input type="hidden" id="tournamentHidden" value="'.$tournament.'">
