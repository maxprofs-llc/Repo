      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="<?=__baseHref__?>/mobile/standings.php">Main</a></li>
            <li><a href="<?=__baseHref__?>/mobile/standings.php?classics=1">Classics</a></li>
            <li><a href="<?=__baseHref__?>/mobile/standings.php?games=1">Games</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </div>
