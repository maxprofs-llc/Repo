...
<font size="2">
<b>Anmälda spelare till Flipper-SM 2007</b>
<br>
<br>
...
<br>
<font size="1">
Dessa Spelare är anmälda till Flipper-SM 2007.<br><br> Du kan ändra spelarens "betalatstatus" i checkboxen i "Betalat" kolumnen: bocka för de som du vill markera som "betalat", klicka sedan på "Uppdatera" längst ner på sidan.<br><br>Om spelaren lämnat ett meddelande kan du läsa detta om du klickar på "Ja" i "Meddelande" kolumnen.
<br><br>
<?
...
echo "<td class='egen2'><a href='anmalda_admin.php?sortera=pris&nysort=yadayadaa'><font size='1'><b>Pris:</b></td>";
...
if ($sortera=='pris' & $nysort=='yadayadaa')
{	
