...
//    printf("<td align=\"center\"> %s </td>", MySQL_result($sqlResult,$c,$arySort["entry"]));
    ...
    printf("<td> <a href=\"sm07.showentry.php?no=%s\">%s</a> </td>", MySQL_result($sqlResult,$c,$arySort["no"]), MySQL_result($sqlResult,$c,$arySort["tag"]));
    ...
    printf("<td> <a href=\"sm07.showgame.php?id=%s\">%s</a> </td>", MySQL_result($sqlResult,$c,"Game_id"), MySQL_result($sqlResult,$c,"Game_name"));
    printf("<td align=\"right\"> %s </td>", number_format(MySQL_result($sqlResult,$c,"Game_points"),0,"."," "));
    printf("<td> <a href=\"sm07.delete.php?try_id=%s\">Ta väck!</a> </td>", MySQL_result($sqlResult,$c,"Try_id"));
    echo "</tr>\n";
    }
