<html>
<head>
  <title>SPELAREINPUT SM07</title>
  <link href="sm07.css" rel="stylesheet" type="text/css">
</head>
<body>


<h2>INSKRIVNING AV SPELARE I SM07</h2>
...
echo "  </table><br>\n";
echo "  <input type='submit' value='Skicka'> &nbsp;&nbsp; <input type='reset' value='Återställ'></p><br>\n\n";
echo "</form>\n";
...
php?>
  ...
  <input type="submit" value="Skicka"> &nbsp;&nbsp; <input type="reset" value="Återställ"></p><br>
</form>
