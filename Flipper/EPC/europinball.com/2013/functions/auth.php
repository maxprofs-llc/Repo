...
function appLoginFail($uid = null, $username = null, $ulogin = null) {
	...
	echo 'login failed<br>'.$_POST['username'].' '.$_POST['password'].' '.$_POST['nonce'].'<br>'.$uid.' '.$username.'<pre>';
  echo '</pre>';
}
...
function showEditPlayer($dbh) {
  ...
  $content = '
    ...
    <div id="changeUser"><a href="https://www.europinball.org/wordpress/your-pages/change-credentials/">Change username or password</a></div>
