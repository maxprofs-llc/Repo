<?php
    ...
    if ($start || $type == $field) {
      ...
      $content .= '
        <div id="'.$field.'Div">
          ...
          <span id="'.$field.'Loading"><img src="/2013/images/ajax-loader.gif" alt="Loading data..."></span>
  ...
  $content .= '
        <div id="playerDiv">
          ...
          <span id="playerLoading"><img src="/2013/images/ajax-loader.gif" alt="Loading data..."></span>
