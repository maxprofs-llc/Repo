...
for($c=0; $c<$intRows; $c++)
    {
    echo "  <tr>";
    printf("<td> <a href=\"bpp07.showgame.php?id=%s\">%s</a> </td>", MySQL_result($sqlResultQual,$c,"Game_id"),MySQL_result($sqlResultQual,$c,"Game_name"));
