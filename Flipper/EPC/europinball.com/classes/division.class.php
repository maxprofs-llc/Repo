    ...
    public function getStandings() {
      if ($this->id == 15) {
        ...
        $div = new div();
          ...
          $player3 = player(2062);
          $player4 = player(2115);      
          $group1div->addSpan('1: '.$player1->getLink().' '.((is_object($player1->country)) ? $player1->country->getIcon() : '').' (2.340.550)')->escape = FALSE;
          $group1div->addBr();
          $group1div->addSpan('2: '.$player2->getLink().' '.((is_object($player2->country)) ? $player2->country->getIcon() : '').' (2.140.490)')->escape = FALSE;
          $group1div->addBr();
          $group1div->addSpan('3: '.$player3->getLink().' '.((is_object($player3->country)) ? $player3->country->getIcon() : '').' (438.290)')->escape = FALSE;
          $group1div->addBr();
          $group1div->addSpan('4: '.$player4->getLink().' '.((is_object($player4->country)) ? $player4->country->getIcon() : '').' (91.070)')->escape = FALSE;
          ...
          $player3 = player(2256);
          $player4 = player(2292);      
          $group1div->addSpan('1: '.$player1->getLink().' '.((is_object($player1->country)) ? $player1->country->getIcon() : '').' (215.170)')->escape = FALSE;
          $group1div->addBr();
          $group1div->addSpan('2: '.$player2->getLink().' '.((is_object($player2->country)) ? $player2->country->getIcon() : '').' (174.150)')->escape = FALSE;
          $group1div->addBr();
          $group1div->addSpan('3: '.$player3->getLink().' '.((is_object($player3->country)) ? $player3->country->getIcon() : '').' (109.360)')->escape = FALSE;
          $group1div->addBr();
          $group1div->addSpan('4: '.$player4->getLink().' '.((is_object($player4->country)) ? $player4->country->getIcon() : '').' (74.160)')->escape = FALSE;
