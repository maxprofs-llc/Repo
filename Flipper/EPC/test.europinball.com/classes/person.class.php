...
/*
    ...
    public function getQrLabel() {
    	echo '<div><table class="qrTable" onclick="window.open(\"'.config::$baseHref.'/ajax/getObj.php?class=person&type=qr&id='.$this->id.'&autoPrint=1\")" title="Click to print"><tr><td>';
