  ...
  class html {
    ...
    public function __construct($element = 'html', $contents = NULL, array $params = NULL, $id = NULL, $class = NULL, array $css = NULL, $indents = 0) {
      ...
      if (get_class($this) == 'html') {
        ...
        $this->contentCrlf = (in_array($this->element, array('a', 'h1', 'h2', 'h3', 'h4', 'li', 'input', 'img', 'span', 'label', 'option'))) ? NULL : "\n";
    ...
    public function getHtml() {
     ...
     if ($this->crlf) {
      ...
      $open .= ($this->contentCrlf && substr($open, strlen($this->contentCrlf) * -1) != $this->contentCrlf && substr(trim($html, static::$indenter), 0, strlen($this->contentCrlf)) != $this->contentCrlf) ? $this->contentCrlf.$indent.static::$indenter : '';
