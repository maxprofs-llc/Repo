...
*/
    ...
    public function addUserReset($person, $title = FALSE, $prefix = 'reset', $class = NULL, $dialog = FALSE, $autoopen = FALSE) {
      $form = self::getUserReset($person, $title, $prefix, $class, $dialog, $autoopen);
      $this->addContent($form);
      return $form;
    }
