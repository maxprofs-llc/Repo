...
*/
    ...
    public function getStandings() {
      if ($this->id == 15) {
        ...
        $group1div->addBr();
        $group1div->addSpan('1: Finland (43p)');
        $group1div->addBr();
        $group1div->addSpan('1: Germany (41p)');
        $group1div->addBr();
        $group1div->addSpan('1: Sweden (38p)');
        ...
        $group2div->addBr();
        $group2div->addSpan('1: Netherlands (56p)');
        $group2div->addBr();
        $group2div->addSpan('1: Poland (49p)');
        $group2div->addBr();
        $group2div->addSpan('1: Austria (31p)');
        $qualDiv->addH2('Finals')->class = 'entry-title';
