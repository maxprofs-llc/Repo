    ...
    public function getEdit($title = 'Edit profile') {
      $content = '
        <div id="editDiv">
          ...
          <p class="label">First Name:</p> <span id="firstName" class="edit">'.(($this->firstName) ? $this->firstName : 'Enter first name').'</span>
          <p class="label">Last Name:</p> <span id="lastName" class="edit">'.(($this->lastName) ? $this->lastName : 'Enter last name').'</span>
          <p class="label">Tag:</p> <span id="shortName" class="edit">'.(($this->shortName) ? $this->shortName : 'Enter tag').'</span>
          <p class="label">Gender:</p> <span id="gender_id" class="edit">'.(($this->gender->name) ? $this->gender->name : 'Choose gender...').'</span>
        </div>
      ';
      return $content;
    }
