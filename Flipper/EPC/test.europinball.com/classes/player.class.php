    ...
    public function getEdit($title = 'Edit profile') {
      $content = '
        <div id="editDiv">
          ...
          <p class="label">First Name:</p> <span class="edit">'.(($this->firstName) ? $this->firstName : 'Enter first name').'</p>
          <p class="label">Last Name:</p> <span class="edit">'.(($this->lastName) ? $this->lastName : 'Enter first name').'</p>
          <p class="label">Tag:</p> <span class="edit">'.(($this->shortName) ? $this->shortName : 'Enter first name').'</p>
          <p class="label">Gender:</p> <span class="edit">'.(($this->gender->name) ? $this->gender->name : 'Choose gender...').'</p>
        </div>
      ';
      return $content;
    }
