...
define('UL_DOMAIN', 'test.europinball.org');

// Set to the path of the "ulogin" directory containing the source files.
// Do not use a trailing slash.
define('UL_INC_DIR', '/www/test.europinball.com/contrib/ulogin');
...
define('UL_SITE_KEY', 'RbsjQZk8k1qFCUa6GUiAjf2FttnjMhj9abPq7Qn95J6jzo2ZeroK8Amc');
...
define('UL_MAX_USERNAME_LENGTH', 32);
...
define('UL_USERNAME_CHECK', '~^[a-zA-Z0-9\-_]{3,32}$~');
...
define('UL_MAX_PASSWORD_LENGTH', 50);
...
define('UL_SITE_ROOT_DIR', '/www/test.europinball.com');
...
define('UL_SESSION_EXPIRE', 86400);
...
define('UL_BF_IP_LOCKOUT', 300);

// Maximum number of login attempts allowed in UL_BF_WINDOW.
define('UL_BF_USER_ATTEMPTS', 20);
