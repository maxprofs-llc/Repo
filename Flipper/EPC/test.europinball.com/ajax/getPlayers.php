        ...
        if ($persons && count($persons) > 0) {
          ...
          foreach ($persons as $person) {
            $json->aaData[] = array(
              ...
              $person->countryName,
              $person->getLink('ifpa'),
              '<img src="'.config::$baseHref.'/images/person.png" title="Click to view photo"><div id="'.$person->id.'" class="hidden photodiv"><img src="'.$person->getPhoto(FALSE, TRUE, FALSE).'"></div>',
