  ...
  if ($page->loggedin()) {
    ...
    $page->content .= '
        ...
        <div id="search" style="display: none">
          ...
          <input type="button" id="nologinButton" value="Search"><input type="button" id="nologinButton" value="Search"><input type="button" id="view_login" class="viewButton" value="Go back to login">
