  ...
  if ($page->checkLogin()) {
    ...
    $page->content .= '
        ...
        <div id="search" style="display: none">
          ...
          <input type="button" id="searchButton" value="Search"><input type="button" id="view_login" class="viewButton" value="Back to login"></p>
          <p>If you realy can\'t find yourself, click this button to register as a new person: <input type="button" id="addButton" value="I\'m a new guy!"></p>
