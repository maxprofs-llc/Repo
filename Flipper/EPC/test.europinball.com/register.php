<?php
  ...
  if ($page->loggedin()) {
    ...
    $page->content .= '
        <div id="login">
          <h2>Register existing player</h2>
          <p>If you participated in EPC 2013 or a any other tournament using this system, then please login here.<p>
    ';
    $page->addLogin('Provide your credentials', true);
    $page->content .= '
          <p>If you are sure you do not have any user, please click this button to proceed: <input type="button" id="nologinButton" value="Search">
        </div>
        <div id="search">
          ...
          <input type="button" id="nologinButton" value="Search"><input type="button" id="nologinButton" value="Search">
