...
$oEntry = new Entry();
$aPlayers = $oEntry->getNumberOfVoidedEntries($iYear, $sDivision);
...
$sJavascriptSelectYear = $oHTMLInput->getSelectID("iYear", $aYears, $aYears, $iYear, $aInputClasses["default"], "onchange=\"statsVoidedEntries()\"");
...
$sJavascriptSelectDivision = $oHTMLInput->getSelectID("sDivision", $aDivisions, $aDivisions, $sDivision, $aInputClasses["default"], "onchange=\"statsVoidedEntries()\"");
...
$oTemplate->assign("bDisplayVoidedEntries", true);
$oTemplate->assign("bDisableHLLinks", true);
$oTemplate->display("statsVoidedEntries.tpl.php");
