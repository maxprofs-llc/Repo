...
<ul id="nav">
	...
	{if #MENU_DISPLAY_REGISTER# == true || #MENU_DISPLAY_REG_PLAYERS# == true}
	...
	{if #MENU_DISPLAY_FINALS# == true}
		<li class="top"><a href="#"  class="top_link"><span class="down">{#MENU_FINALS#}</span><!--[if gte IE 7]><!--></a><!--			<![endif]-->			
			...
			{if $menu_results_year_already_shown != $g_aYearsWithFinals[section].year}
				<li><a href="#"><b>{$g_aYearsWithFinals[section].year}</b></a></li> 
		                {assign var="menu_results_year_already_shown" value=$g_aYearsWithFinals[section].year}
			{/if}
...
<!--				<li><a href="#"><b>{$g_aYearsWithResults[section]}</b></a></li> -->
	...
	{if #MENU_DISPLAY_RESULTS_OLD# == true}	
		<li class="top"><a href="#"  class="top_link"><span class="down">{#MENU_RESULTS#}</span><!--[if gte IE 7]><!--></a><!--<![endif]-->
			<!--[if lte IE 6]><table><tr><td><![endif]--><ul class="sub">
			{section name=section loop=$g_aYearsWithFinals}
				{if $menu_results_year_already_shown != $g_aYearsWithFinals[section].year}
	...
	{if #MENU_DISPLAY_MISC# == true}	
		<li class="top"><a href="#"  class="top_link"><span class="down">{#MENU_MISC#}</span><!--[if gte IE 7]><!--></a><!--<![endif]-->
			...
			{/if}
                        {if #MENU_DISPLAY_TSHIRT# == true}
                                <li><a href="tshirt.php">{#MENU_TSHIRT#}</a></li>
                        {/if}
			{if #MENU_DISPLAY_PRESS# == true}
				<li><a href="press.php">{#MENU_PRESS#}</a></li>
			{/if}		
			{if #MENU_DISPLAY_VIDEO# == true}
				<li><a href="video.php">{#MENU_VIDEO#}</a></li>
			{/if}		
			{if #MENU_DISPLAY_SOCIAL# == true}
				<li><a href="social.php">{#MENU_SOCIAL#}</a></li>
			{/if}		
