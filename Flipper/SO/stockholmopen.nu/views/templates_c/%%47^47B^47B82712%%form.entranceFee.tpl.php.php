<?php /* Smarty version 2.6.16, created on 2013-04-22 05:42:37
...
...</td>
 ...
 / <?php echo $this->_config[0]['vars']['SPLIT_TOURNAMENT_ENTRANCE_PRICE_GBP']; ?>
	...
	<tr>
        ...
        <tr>
                <td class='inputLabel'><?php echo $this->_config[0]['vars']['TSHIRT_FEES']; ?>
</td>
                <td><?php echo $this->_tpl_vars['aInputs']['iTShirt']['input']; ?>
 ...
 / <?php echo $this->_config[0]['vars']['TSHIRT_PRICE_GBP']; ?>
        ...
        <tr>
                <td class='inputLabel'><?php echo $this->_config[0]['vars']['TSHIRT_SIZE']; ?>
</td>
                <td><?php echo $this->_tpl_vars['aInputs']['sTShirtSize']['input']; ?>
</td>
        </tr>
        <tr>
                <td class='inputLabel'><?php echo $this->_config[0]['vars']['TSHIRT_COLOR']; ?>
</td>
                <td><?php echo $this->_tpl_vars['aInputs']['sTShirtColor']['input']; ?>
</td>
        </tr>
        <tr>
                <td></td>
                <td><i><?php echo $this->_config[0]['vars']['TSHIRT_SIZE_NOTE']; ?>
</i></td>
        </tr>
	<tr>
