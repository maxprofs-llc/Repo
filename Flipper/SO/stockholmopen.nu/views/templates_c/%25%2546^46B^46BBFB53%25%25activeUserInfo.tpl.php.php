...
<p>
<?php $this->assign('iUsers', count($this->_tpl_vars['g_aActiveUsers']));  $this->assign('iGuests', count($this->_tpl_vars['g_aActiveGuests']));  if ($this->_tpl_vars['iUsers'] > 0 && $this->_tpl_vars['iGuests'] > 0): ?>
