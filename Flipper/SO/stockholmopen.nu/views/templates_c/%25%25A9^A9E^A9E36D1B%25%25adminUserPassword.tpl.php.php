<?php /* Smarty version 2.6.16, created on 2008-03-30 04:48:01
         compiled from admin/adminUserPassword.tpl.php */ ?>
...
: <?php echo $this->_config[0]['vars']['ADMIN_CHANGE_PASSWORD_HL']; ?>
</h2>
<?php echo $this->_config[0]['vars']['ADMIN_CHANGE_PASSWORD_MAIN']; ?>
...
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "formsAdmin/form.userPassword.tpl.php", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
