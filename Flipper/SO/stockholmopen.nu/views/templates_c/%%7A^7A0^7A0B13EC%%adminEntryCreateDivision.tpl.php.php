<?php /* Smarty version 2.6.16, created on 2008-03-30 21:48:51
         compiled from admin/adminEntryCreateDivision.tpl.php */ ?>
...
: <?php echo $this->_config[0]['vars']['ADMIN_ENTRY_CREATE_HL']; ?>
 ( <?php echo $this->_config[0]['vars']['STEP_TWO_OF_FIVE']; ?>
 )</h2>
...
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "formsAdmin/form.entryCreateDivision.tpl.php", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
