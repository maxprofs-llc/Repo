<?php /* Smarty version 2.6.16, created on 2008-06-05 19:18:43
...
<br />
		<?php endif; ?>
		<?php if ($this->_tpl_vars['aCustomErrors']['voidedTeam'] == true): ?>
			- <?php echo $this->_config[0]['vars']['SPLIT_TEAM_IS_VOIDED']; ?>
<br />
		<?php endif; ?>			
	</div>
	<br />
