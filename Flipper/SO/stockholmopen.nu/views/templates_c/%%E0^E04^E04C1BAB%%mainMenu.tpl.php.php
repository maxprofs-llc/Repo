<?php /* Smarty version 2.6.16, created on 2013-06-19 18:34:45
         compiled from menus/mainMenu.tpl.php */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'upper', 'menus/mainMenu.tpl.php', 103, false),)), $this); ?>
...
<ul id="nav">
	...
	<?php if ($this->_config[0]['vars']['MENU_DISPLAY_GENERAL'] == true): ?>	
		<li class="top"><a href="#"  class="top_link"><span class="down"><?php echo $this->_config[0]['vars']['MENU_GENERAL']; ?>
			...
			<?php endif; ?>
			<?php if ($this->_config[0]['vars']['MENU_DISPLAY_PRIZES'] == true): ?>
				<li><a href="prizes.php"><?php echo $this->_config[0]['vars']['MENU_PRIZES']; ?>
</a></li>
			<?php endif; ?>
	...
	<?php if ($this->_config[0]['vars']['MENU_DISPLAY_REGISTER'] == true || $this->_config[0]['vars']['MENU_DISPLAY_REG_PLAYERS'] == true): ?>
...
&amp;sDivision=S"><?php echo $this->_config[0]['vars']['MENU_REGISTERED_TEAMS']; ?>
			...
			<?php if ($this->_config[0]['vars']['MENU_DISPLAY_VOLUNTEER'] == true || $this->_config[0]['vars']['MENU_DISPLAY_VOLUNTEERS'] == true): ?>
				<li><a href="#"><b><?php echo $this->_config[0]['vars']['MENU_VOLUNTEERS_SECTION']; ?>
</b></a></li>
			<?php endif; ?>

			<?php if ($this->_config[0]['vars']['MENU_DISPLAY_VOLUNTEER'] == true): ?>
				<li><a href="volunteer.php"><?php echo $this->_config[0]['vars']['MENU_VOLUNTEER']; ?>
</a></li>
			<?php endif; ?>

			<?php if ($this->_config[0]['vars']['MENU_DISPLAY_VOLUNTEERS'] == true): ?>
				<li><a href="volunteers.php"><?php echo $this->_config[0]['vars']['MENU_VOLUNTEERS']; ?>
</a></li>
			<?php endif; ?>
...
$this->_sections['section']['last']       = ($this->_sections['section']['iteration'] == $this->_sections['section']['total']);
?>
			<?php if ($this->_tpl_vars['menu_results_year_already_shown'] != $this->_tpl_vars['g_aYearsWithFinals'][$this->_sections['section']['index']]['year']): ?>
				<li><a href="#"><b><?php echo $this->_tpl_vars['g_aYearsWithFinals'][$this->_sections['section']['index']]['year']; ?>
</b></a></li> 
		                <?php $this->assign('menu_results_year_already_shown', $this->_tpl_vars['g_aYearsWithFinals'][$this->_sections['section']['index']]['year']); ?>
			<?php endif; ?>
...
$this->_sections['section']['last']       = ($this->_sections['section']['iteration'] == $this->_sections['section']['total']);
?>
<!--				<li><a href="#"><b><?php echo $this->_tpl_vars['g_aYearsWithResults'][$this->_sections['section']['index']]; ?>
</b></a></li> -->
...
"><?php echo $this->_config[0]['vars']['MENU_ITEM_RESULTS']; ?>
 <?php echo $this->_tpl_vars['g_aYearsWithResults'][$this->_sections['section']['index']]; ?>
	...
	<?php if ($this->_config[0]['vars']['MENU_DISPLAY_RESULTS_OLD'] == true): ?>	
		<li class="top"><a href="#"  class="top_link"><span class="down"><?php echo $this->_config[0]['vars']['MENU_RESULTS']; ?>
</span><!--[if gte IE 7]><!--></a><!--<![endif]-->
			<!--[if lte IE 6]><table><tr><td><![endif]--><ul class="sub">
			<?php unset($this->_sections['section']);
 ...
 - <?php echo $this->_tpl_vars['g_aYearsAndDivisions'][$this->_sections['section']['index']]['dty_year_for_division']; ?>
	...
	<?php if ($this->_config[0]['vars']['MENU_DISPLAY_MISC'] == true): ?>	
		<li class="top"><a href="#"  class="top_link"><span class="down"><?php echo $this->_config[0]['vars']['MENU_MISC']; ?>
			...
			<?php endif; ?>
                        <?php if ($this->_config[0]['vars']['MENU_DISPLAY_TSHIRT'] == true): ?>
                                <li><a href="tshirt.php"><?php echo $this->_config[0]['vars']['MENU_TSHIRT']; ?>
</a></li>
                        <?php endif; ?>
			...
			<?php endif; ?>		
			<?php if ($this->_config[0]['vars']['MENU_DISPLAY_VIDEO'] == true): ?>
				<li><a href="video.php"><?php echo $this->_config[0]['vars']['MENU_VIDEO']; ?>
</a></li>
			<?php endif; ?>		
			<?php if ($this->_config[0]['vars']['MENU_DISPLAY_SOCIAL'] == true): ?>
				<li><a href="social.php"><?php echo $this->_config[0]['vars']['MENU_SOCIAL']; ?>
</a></li>
			<?php endif; ?>		
...
"><?php echo $this->_tpl_vars['g_aYearsWithGallery'][$this->_sections['section']['index']]; ?>
			...
			<?php if ($this->_config[0]['vars']['MENU_DISPLAY_SLIDE'] == true): ?>
				<?php if ($this->_config[0]['vars']['MENU_YEAR_HIDE'] == null): ?>
					<li><a href="#"><b><?php echo $this->_config[0]['vars']['MENU_SLIDE_SECTION']; ?>
</b></a></li>
	...
	<?php if ($this->_tpl_vars['g_aUserAdminTasks'] != null): ?>
		<li class="top"><a href="#"  class="top_link"><span class="down"><?php echo $this->_config[0]['vars']['MENU_ADMIN']; ?>
			...
			<?php if ($this->_tpl_vars['g_aUserAdminTasks']['admin_uber'] == 'true'): ?>		
				...
				<li><a href="adminCalcStandings.php"><?php echo $this->_config[0]['vars']['MENU_ADMIN_CALC_STANDINGS']; ?>
</a></li>
