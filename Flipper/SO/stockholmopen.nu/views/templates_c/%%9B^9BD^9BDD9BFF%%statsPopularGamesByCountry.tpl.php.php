<?php /* Smarty version 2.6.16, created on 2008-04-20 20:19:03
         compiled from statsPopularGamesByCountry.tpl.php */ ?>
...
<h2><?php echo $this->_config[0]['vars']['STATS_POPULAR_GAMES_BY_COUNTRY_HL']; ?>
...
<?php echo $this->_config[0]['vars']['STATS_POPULAR_GAMES_BY_COUNTRY_MAIN']; ?>

<br />
<br />

<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "recycled/noOfEntryRounds.tpl.php", 'smarty_include_vars' => array('title' => 'entryRounds')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
