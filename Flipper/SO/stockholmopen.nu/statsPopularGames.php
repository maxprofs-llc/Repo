...
$oEntry = new Entry();
$aGameRounds = $oEntry->getNoOfRoundsForGame($iYear, $sDivision, true);
...
$sJavascriptSelectYear = $oHTMLInput->getSelectID("iYear", $aYears, $aYears, $iYear, $aInputClasses["default"], "onchange=\"statsPopularGames()\"");
...
$sJavascriptSelectDivision = $oHTMLInput->getSelectID("sDivision", $aDivisions, $aDivisions, $sDivision, $aInputClasses["default"], "onchange=\"statsPopularGames()\"");
...
$oTemplate->display("statsPopularGames.tpl.php");
