...
$oEntry = new Entry();
$aGameRounds = $oEntry->getMostPopularMachinesByCountry($iYear, $sDivision, true);
...
$sJavascriptSelectYear = $oHTMLInput->getSelectID("iYear", $aYears, $aYears, $iYear, $aInputClasses["default"], "onchange=\"statsMachinesByCountry()\"");
...
$sJavascriptSelectDivision = $oHTMLInput->getSelectID("sDivision", $aDivisions, $aDivisions, $sDivision, $aInputClasses["default"], "onchange=\"statsMachinesByCountry()\"");
...
$oTemplate->assign("aGameRounds", $aGameRounds);
$oTemplate->assign("bDisplayCountryHeadline", true);
$oTemplate->display("statsPopularGamesByCountry.tpl.php");
