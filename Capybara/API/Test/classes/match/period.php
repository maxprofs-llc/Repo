<?php
	...
	class match_period extends baseClass {
		...
		public $played; // Bool - TRUE = already played, FALSE = future period, NULL = Same as match
		public $startingTeamId;
		public $startingGeoDirectionId;
		...
		function getStartingGeoDirection() {
			return data_dataStore::getProperty('dataReader')->getGeoDirectionById($this->startingGeoDirectionId);
		}
		...
		function getPeriodType() {
			return data_dataStore::getProperty('dataReader')->getGenericById($this->periodTypeId,'periodType','pt','match_periodType');
		}
	}