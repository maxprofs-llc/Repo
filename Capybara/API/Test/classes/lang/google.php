...
class lang_google {
         ...
         */
        static function translate($text, $from = 'en', $to) {
        ...
        function _unescapeUTF8EscapeSeq($str) {
                return preg_replace_callback("/\\\u([0-9a-f]{4})/i", create_function('$matches', 'return lang_google::_bin2utf8(hexdec($matches[1]));'), $str);
        }
